...
function processData(data) {
  ...
  data.forEach(function(d) {
    ...
    // // Calculate death per allegiance
    // if (!isNaN(e.y)) {
    //   if (!isNaN(deathPerAllegiance[d.Allegiances])) 
    //   {
    //     deathPerAllegiance[d.Allegiances]++;
    //   }
    //   else{
    //     deathPerAllegiance[d.Allegiances] =1;
    //   }

    // }
    // res.deathPerAllegiance = deathPerAllegiance;
...
function main() {
  d3.csv("full.csv", function(error, orignalData) {
